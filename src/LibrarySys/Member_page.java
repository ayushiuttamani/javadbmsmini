...
public class Member_page extends javax.swing.JFrame {
    ...
    public Member_page(String abc,String bcd) {
        initComponents();
        jLabel2.setText(abc);
        jLabel4.setText(bcd);
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Member's Page", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Gill Sans MT", 1, 24))); // NOI18N

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jRadioButton1.setText("View All Available Books");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jRadioButton2.setText("View Borrowed Books");
        ...
        jRadioButton3.setText("Borrow Books");
...
// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jRadioButton1.isSelected())
        {
            //this.setVisible(false);
            this.dispose();
            new M_View_All_Books(a,c).setVisible(true);
        }
        else if(jRadioButton3.isSelected())
        {
            //this.setVisible(false);
            this.dispose();
            new M_Borrow_Books(a,c).setVisible(true);
        }
        else if(jRadioButton2.isSelected())
        {
            //this.setVisible(false);
            this.dispose();
            new M_View_Borrowed_Books(a,c).setVisible(true);
        }
        // TODO add your handling code here:
