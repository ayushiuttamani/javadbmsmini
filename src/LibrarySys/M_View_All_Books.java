...
public class M_View_All_Books extends javax.swing.JFrame {

    /**
     * Creates new form M_View_All_Books
     */
    public M_View_All_Books() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public M_View_All_Books(String abc,String dbc) {
        initComponents();
        jLabel3.setText(abc);
        jLabel5.setText(dbc);
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "View All Available books", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Gill Sans MT", 1, 24))); // NOI18N
        ...
        jLabel1.setText("Enter Book Name To Search For");
        ...
        jLabel4.setText("Your Member ID");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql = "select * from books where viewallbooks like '%"+jTextField1.getText()+"%' and availability='yes';";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Class.forName("java.sql.DriverManager");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bookstore","root","Ayushi@123");
            String sql = "select * from viewallbooks;";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_View_All_Books.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new M_View_All_Books().setVisible(true);
            }
        });
    }
