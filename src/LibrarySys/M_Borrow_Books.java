...
public class M_Borrow_Books extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            Connection con;
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bookstore","root","Ayushi@123");
            String sql1;
            sql1 = "Insert into issuedbooks values('"+jTextField1.getText()+"','"+jTextField2.getText()+"');";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "select * from viewallbooks where availability='yes';";
            Statement stmt = con.createStatement();
